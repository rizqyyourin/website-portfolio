<template>
  <section id="projects" class="py-24 md:py-32 bg-zinc-900 relative overflow-hidden">
    <!-- Background Patterns -->
    ...
    <div class="absolute -right-20 top-40 w-96 h-96 bg-red-600 rounded-full blur-[128px] opacity-20 pointer-events-none"></div>
